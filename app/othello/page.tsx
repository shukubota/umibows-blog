...
const Page: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-white">
      <div className="grid grid-cols-8 gap-0" style={{ width: '50rem', height: '50rem', maxWidth: '800px' }}>
        {rows.map((row) =>
          columns.map((col) => (
            <div
              key={`${row}-${col}`}
            ...
            >
              <div className={`absolute inset-0 flex items-center justify-center ${getStone(row, col)} rounded-full`} />
