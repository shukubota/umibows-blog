...
export default function NumericalComparisonPage() {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      ctx.strokeStyle = "#aaa";
      ctx.lineWidth = 2;
      ctx.moveTo(centerX, eulerY);
      ctx.lineTo(centerX + euler.x, eulerY);
      ctx.stroke();
      // Vertical barrier line
      ctx.beginPath();
      ctx.strokeStyle = "#000";
      ctx.lineWidth = 2;
      ctx.moveTo(centerX, eulerY - 30);
      ctx.lineTo(centerX, eulerY + 30);
      ctx.stroke();
      ...
      ctx.strokeStyle = "#aaa";
      ctx.lineWidth = 2;
      ctx.moveTo(centerX, rk4Y);
      ctx.lineTo(centerX + rk4.x, rk4Y);
      ctx.stroke();
      // Vertical barrier
      ctx.beginPath();
      ctx.strokeStyle = "#000";
      ctx.lineWidth = 2;
      ctx.moveTo(centerX, rk4Y - 30);
      ctx.lineTo(centerX, rk4Y + 30);
      ctx.stroke();
      ...
      ctx.strokeStyle = "#aaa";
      ctx.lineWidth = 2;
      ctx.moveTo(centerX, anaY);
      ctx.lineTo(centerX + analytical.x, anaY);
      ctx.stroke();
      // Vertical barrier
      ctx.beginPath();
      ctx.strokeStyle = "#000";
      ctx.lineWidth = 2;
      ctx.moveTo(centerX, anaY - 30);
      ctx.lineTo(centerX, anaY + 30);
      ctx.stroke();
    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-8 bg-gray-50 dark:bg-gray-900">
      <div className="w-full max-w-4xl bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 flex flex-col items-center">
        ...
        <p className="mb-6 text-gray-600 dark:text-gray-400">
          Comparing Euler&apos;s Method, Runge-Kutta 4 (RK4), and Analytical Solution for a Harmonic
          Oscillator. Notice how Euler diverges (adds energy) over time, while RK4 stays accurate.
        </p>

        <div className="relative border rounded-lg overflow-hidden bg-white shadow-inner mb-6">
          <canvas ref={canvasRef} width={800} height={500} className="block bg-white" />
        </div>
          ...
          <div className="space-y-4">
              ...
              <div className="space-y-3 text-gray-800 dark:text-gray-200">
                <div
                  dangerouslySetInnerHTML={{
                    __html: katex.renderToString("\\frac{dx}{dt} = v", { displayMode: true }),
                  }}
                />
                <div
                  dangerouslySetInnerHTML={{
                    __html: katex.renderToString("\\frac{dv}{dt} = -\\frac{k}{m} x", {
                      displayMode: true,
                    }),
                  }}
                />
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: katex.renderToString(
                      `\\text{where } k = ${k}, \\, m = ${m}, \\, \\omega = \\sqrt{\\frac{k}{m}} = ${omega.toFixed(3)}`,
                      { displayMode: true }
                    ),
                  }}
                />
            ...
            <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border-l-4 border-red-500">
              ...
              <div className="space-y-3 text-gray-800 dark:text-gray-200">
                <div
                  dangerouslySetInnerHTML={{
                    __html: katex.renderToString("x_{n+1} = x_n + v_n \\cdot \\Delta t", {
                      displayMode: true,
                    }),
                  }}
                />
                <div
                  dangerouslySetInnerHTML={{
                    __html: katex.renderToString("v_{n+1} = v_n + a_n \\cdot \\Delta t", {
                      displayMode: true,
                    }),
                  }}
                />
                <div
                  className="mt-3 text-sm text-gray-500 dark:text-gray-400"
                  dangerouslySetInnerHTML={{
                    __html: katex.renderToString("\\text{where } a_n = -\\frac{k}{m} x_n", {
                      displayMode: true,
                    }),
                  }}
                />
            ...
            <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border-l-4 border-blue-500">
              ...
              <div className="space-y-3 text-gray-800 dark:text-gray-200">
                <div
                  dangerouslySetInnerHTML={{
                    __html: katex.renderToString("k_1 = f(x_n, v_n)", { displayMode: true }),
                  }}
                />
                <div
                  dangerouslySetInnerHTML={{
                    __html: katex.renderToString(
                      "k_2 = f\\left(x_n + k_1.dx \\cdot \\frac{\\Delta t}{2}, \\, v_n + k_1.dv \\cdot \\frac{\\Delta t}{2}\\right)",
                      { displayMode: true }
                    ),
                  }}
                />
                <div
                  dangerouslySetInnerHTML={{
                    __html: katex.renderToString(
                      "k_3 = f\\left(x_n + k_2.dx \\cdot \\frac{\\Delta t}{2}, \\, v_n + k_2.dv \\cdot \\frac{\\Delta t}{2}\\right)",
                      { displayMode: true }
                    ),
                  }}
                />
                <div
                  dangerouslySetInnerHTML={{
                    __html: katex.renderToString(
                      "k_4 = f(x_n + k_3.dx \\cdot \\Delta t, \\, v_n + k_3.dv \\cdot \\Delta t)",
                      { displayMode: true }
                    ),
                  }}
                />
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: katex.renderToString(
                      "x_{n+1} = x_n + \\frac{k_1.dx + 2k_2.dx + 2k_3.dx + k_4.dx}{6} \\cdot \\Delta t",
                      { displayMode: true }
                    ),
                  }}
                />
                <div
                  dangerouslySetInnerHTML={{
                    __html: katex.renderToString(
                      "v_{n+1} = v_n + \\frac{k_1.dv + 2k_2.dv + 2k_3.dv + k_4.dv}{6} \\cdot \\Delta t",
                      { displayMode: true }
                    ),
                  }}
                />
            ...
            <div className="p-4 bg-white dark:bg-gray-800 rounded-lg border-l-4 border-green-600">
              ...
              <div className="space-y-3 text-gray-800 dark:text-gray-200">
                ...
                <div
                  className="mt-3 text-sm text-gray-500 dark:text-gray-400"
                  dangerouslySetInnerHTML={{
                    __html: katex.renderToString(`\\text{where } x_0 = ${x0}, \\, v_0 = ${v0}`, {
                      displayMode: true,
                    }),
                  }}
                />
