                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                <span className="px-3 py-1 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded-full text-sm">Go</span>
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                <span className="px-3 py-1 bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 rounded-full text-sm">Kubernetes</span>
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                <span className="px-3 py-1 bg-orange-100 dark:bg-orange-900 text-orange-800 dark:text-orange-200 rounded-full text-sm">CI/CD</span>
                                <span className="px-3 py-1 bg-orange-100 dark:bg-orange-900 text-orange-800 dark:text-orange-200 rounded-full text-sm">Agile</span>
                                <span className="px-3 py-1 bg-orange-100 dark:bg-orange-900 text-orange-800 dark:text-orange-200 rounded-full text-sm">TDD</span>
                            </div>
                        </div>
                    </div>
                </div>
